...
async function run() {
  await pool.query('DELETE FROM ims_items WHERE workspace_id = $1 AND barcode IN ($2, $3, $4, $5)', [WORKSPACE_ID, students[0].barcode, students[1].barcode, students[2].barcode, students[3].barcode]);
