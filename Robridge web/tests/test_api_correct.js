// Test the API endpoint directly with correct JWT secret
...
async function testAPI() {
    try {
        ...
        // Generate a valid JWT token for user 11 with CORRECT secret
        const token = jwt.sign(
            { id: 11, username: 'testuser1' },
            'robridge-secret-key-change-in-production-2024'
        );
